...
const Productos1 = new Product("zapatillas nike-black", 5250, "img zapatillas nike-black", "zapatillas running", "**** *** *****", 50);
const Productos2 = new Product("zapatillas adidas-blancas", 7543, "img zapatillas adidas-blancas", "zapatillas adidas", "*** ***** ***", 20);
const Productos3 = new Product("zapatillas newbalance-new", 6420, "img zapatillas newbalance-new", "zapatillas unisex", "** **** *****", 40);
...
const updatedFields = { precio: 5999, stock: 25 };
